...
public class InsertBookActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnInsertBook.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(authorData==null)
				{
					Toast.makeText(InsertBookActivity.this, "Vui Lòng Chọn Kho Hàng Để Thêm Vào", Toast.LENGTH_LONG).show();
					return;
				}
				...
				if(bId>0)
				{
					Toast.makeText(InsertBookActivity.this, "Thêm Thành Công", Toast.LENGTH_LONG).show();
					loadListBookByAuthor(authorData.getField1().toString());
				}
				else
				{
					Toast.makeText(InsertBookActivity.this, "Thêm Không Thành Công", Toast.LENGTH_LONG).show();
				}
			}
		});
	}
	 ...
	 */
	private OnDateSetListener dateChange= new OnDateSetListener() {
