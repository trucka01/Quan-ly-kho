...
//		});
	...
	public void updateUI()
	{
		...
		if(database!=null)
		{
			...
			header.setField2("Mã Kho");
			header.setField3("Tên Kho");
			list.add(header);
			cursor.moveToFirst();
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
						int arg2, long arg3) {
					// TODO Auto-generated method stub
//					Toast.makeText(ShowListAuthorActivity.this,""+ list.get(arg2).toString(), Toast.LENGTH_LONG).show();
					...
					startActivityForResult(intent, Main2Activity.OPEN_AUTHOR_DIALOG);
				}
			});
			lv.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
					...
					final int pos=arg2;
//					Toast.makeText(ShowListAuthorActivity.this, ""+data.toString(), Toast.LENGTH_LONG).show();
					Builder b=new Builder(ShowListAuthorActivity.this);
					b.setTitle("Remove");
					b.setMessage("Xóa ["+data.getField2() +""+data.getField3() +"");
					b.setPositiveButton("Có", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							if(n>0)
							{
								Toast.makeText(ShowListAuthorActivity.this, "Xóa Thành Công", Toast.LENGTH_LONG).show();
								list.remove(pos);
								adapter.notifyDataSetChanged();
							}
							else
							{
								Toast.makeText(ShowListAuthorActivity.this, "Xóa Không Thành Công", Toast.LENGTH_LONG).show();
							}
						}
					});
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode== Main2Activity.SEND_DATA_FROM_AUTHOR_ACTIVITY)
		{
			...
			if(database!=null)
			{
				...
				if(n>0)
				{
					Toast.makeText(ShowListAuthorActivity.this, "Sửa Thành Công", Toast.LENGTH_LONG).show();
